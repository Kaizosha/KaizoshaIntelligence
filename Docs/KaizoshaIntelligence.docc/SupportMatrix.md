...
- Anthropic image input is model-family dependent. The current adapter treats Claude 3 and Claude 4 era models as vision-capable and keeps document/file inputs out of the shared API until that mapping is implemented directly.
